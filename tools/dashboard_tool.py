...
class DashBoard:
    ...
    async def dashboard_setup(self):
        ...
        text_channel:discord.TextChannel = await self.ctx.guild.create_text_channel(name='천상-봇-대시보드')
        ...
        for channel in self.interaction.guild.text_channels:
            if (
                ...
                try:
                    ...
                    return await msg.delete()
        await self.interaction.guild.create_text_channel(name='천상봇-공지사항',topic='-HOnNt')
        await self.interaction.channel.send('✅ 성공적으로 설정하였습니다.',delete_after=5)
